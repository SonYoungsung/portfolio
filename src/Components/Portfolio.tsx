        ...
        <Wrap>
                {item !== undefined ? ( <Frame >
                  ...
                  <Frame_Description>
                        ...
                        <FontAwesomeIcon icon={faGithub} size="4x" style={{paddingTop: "20px", cursor: "pointer"}} onClick={()=>openWindow(item.url)}></FontAwesomeIcon>
                      </Frame_Description>          
              </Frame>) : <div>404 ERROR</div>}
              
                
                <div>
                <ViewButton onClick={()=>openWindow(item.url)}>Link to Homepage</ViewButton>
